    ...
    <div className="relative min-h-[100dvh] overflow-hidden bg-cyber-void">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] max-w-5xl flex-col justify-center px-6 py-16 sm:px-10">
        ...
        <p className="mt-8 max-w-xl font-mono text-sm leading-relaxed text-white/60">
          画面の案内に沿って選ぶだけで、仮想通貨を作る流れをやさしく体験できます。
          チェーンごとの手数料や通信速度の違いをイメージしながら試せますが、
          実際のブロックチェーンには接続していないシミュレーションです。
        </p>
          ...
          {[
            {
              k: "01",
              t: "Routing",
              d: "どのネットワークで使う想定かを選び、手数料や通信速度の違いを見比べます。",
            },
            {
              k: "02",
              t: "Semantics",
              d: "何のためのトークンかを決めます。特典向け、ミーム向け、投票向けなどから選べます。",
            },
            {
              k: "03",
              t: "Pulse",
              d: "名前や発行枚数を入力すると、発行から値動き確認までの流れをまとめて体験できます。",
            },
          ].map((item) => (
            <div
              key={item.k}
